...
const ConnectWallet = () => {
    ...
    const switchNetwork = async () => {
        try {
            ...
            const res = await provider.request({
                ...
                params: [{ chainId: ethers.utils.hexlify(Number(MUMBAI_TESTNET_ID))}],
            });
            dispatch(setNetwork(MUMBAI_TESTNET_ID));
    ...
    const addMumbaiToMetamask = async () => {
        try {
            const provider = window.ethereum;
            await provider.request({
                ...
                params: [
                    ...
                    { 
                        chainId: ethers.utils.hexValue(MUMBAI_TESTNET_ID),
            ...
            <div>
                <Modal show={!correctNetwork}>
                    ...
                    <Modal.Body>
                        ...
                        <p>
                            We support Mumbai testnet
                        </p>
                        <button onClick={switchNetwork} className="baseButton">Switch network</button>
                        <button onClick={addMumbaiToMetamask} className="inverseButton">Add Mumbai to metamask</button>
